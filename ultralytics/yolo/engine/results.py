...
class SubResults:
    ...
    def __init__(self, boxes=None, classes=None, result=None, category=None) -> None:
        self.boxes = boxes if boxes is not None else None
        ...
        self.comp = ["boxes", "category", "classes", "result"]
